...
| Locked final test | 2025-01-01 to 2025-06-30 | consumed: evaluated once at release, 2026-07-10 (`--final-test`, results in the model card) |
...
- Maintenance / update cadence: extended by the manually dispatched monthly BTS refresh as new months publish; weather sources stay pinned (`era5`, `gfs_seamless`) so refetches are reproducible
