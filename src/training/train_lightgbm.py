"""
Train LightGBM model for delay prediction.
...
def main():
    print("Training LightGBM Delay Model...")
    ...
    # same 57 features as XGBoost so the comparison is fair
    ...
    # max_depth=-1 lets LightGBM grow as deep as it wants,
    # num_leaves controls complexity instead
    lgb_params = {
        "n_estimators": 500,
        "max_depth": -1,
        "num_leaves": 63,
    ...
    model_path = MODELS_DIR / "lightgbm_delay.pkl"
    ...
    importance_path = MODELS_DIR / "lightgbm_feature_importance.csv"
